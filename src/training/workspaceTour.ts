...
export const WORKSPACE_TOUR_STEPS: WorkspaceTourStep[] = [
  ...
  },
  {
    ...
    body: 'This banner is a count, not a patient list. The application is yours from the moment the patient applies, and the HHH team reviews it on your behalf before it is referred. Open Patients to see who is assigned to you. Do not treat Overview as the place to accept or decline.',
  },
  {
    id: 'overview-daily',
    screen: 'home',
